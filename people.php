<?php
    ...
    function GetProfileInfo($userId)
	{
		...
		$query = "SELECT ".DB_USERS_ID.",".DB_USERS_USERNAME.",".DB_USERS_FIRSTNAME.",".DB_USERS_LASTNAME.",".DB_USERS_EMAIL.",".DB_USERS_BIRTH.",".DB_USERS_PHONE.",".DB_USERS_SEX.",".DB_USERS_EXPERIENCE.",".DB_USERS_LEVEL.",".DB_USERS_IMAGE.
